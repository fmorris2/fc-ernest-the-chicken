...
public class PickupRubberTube extends BasicInteractionTask implements ItemsRequiredTask
{
	...
	{
		return new PickUpGroundItem("Rubber tube");
	}

	@Override
	protected BooleanSupplier getWaitCondition()
	{
		return () -> Inventory.getCount(FCErnestTheChicken.RUBBER_TUBE) > 0;
	}
	...
	{
		return ETCSettings.PICKUP_TUBE.isValid();
	}

	@Override
	public String getStatus()
	{
		return "Pickup rubber tube";
	}
	...
	public FCItem[] getRequiredItems()
	{
		return new FCItem[]
		{
			new FCItem(1, false, FCErnestTheChicken.KEY)
		};
	}
